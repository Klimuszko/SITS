...
return [
    ...
    'audit_action' => [
        ...
        'ticket.deleted' => 'Trwale usunięto zgłoszenie',
        'asset.created' => 'Utworzono zasób',
        'asset.updated' => 'Zmieniono zasób',
        'asset.archived' => 'Zarchiwizowano zasób',
        'asset.deleted' => 'Trwale usunięto zasób',
        'asset_category.deleted' => 'Trwale usunięto kategorię zasobów',
        'asset_section.deleted' => 'Trwale usunięto węzeł struktury zasobu',
        'asset_field.deleted' => 'Trwale usunięto pole zasobu',
        'ticket_category.deleted' => 'Trwale usunięto kategorię zgłoszeń',
        'ticket_priority.deleted' => 'Trwale usunięto priorytet zgłoszeń',
        'knowledge_category.deleted' => 'Trwale usunięto kategorię bazy wiedzy',
