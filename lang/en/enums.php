...
return [
    ...
    'audit_action' => [
        ...
        'ticket.deleted' => 'Ticket permanently deleted',
        'asset.created' => 'Asset created',
        'asset.updated' => 'Asset updated',
        'asset.archived' => 'Asset archived',
        'asset.deleted' => 'Asset permanently deleted',
        'asset_category.deleted' => 'Asset category permanently deleted',
        'asset_section.deleted' => 'Asset structure node permanently deleted',
        'asset_field.deleted' => 'Asset field permanently deleted',
        'ticket_category.deleted' => 'Ticket category permanently deleted',
        'ticket_priority.deleted' => 'Ticket priority permanently deleted',
        'knowledge_category.deleted' => 'Knowledge category permanently deleted',
